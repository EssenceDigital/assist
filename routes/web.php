...
Route::get('/timesheets/{from_date}/{to_date}/{project_id}/{user_id}/{auth_user_only}', 'TimesheetsController@filter');
Route::get('/timesheets/auth-users', 'TimesheetsController@authUsersTimesheets');